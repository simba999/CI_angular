									...
									<table id="exampleForContactTbl" class="table table-bordered contact-list-table">
										...
										<tr dir-paginate="user in overDueTaskData.data|itemsPerPage:overDueTaskData.itemsPerPage" total-items="overDueTaskData.total_count">
											...
											<td class="text-center">
												...
												<img src="{{user.ProfileImage}}" alt="image not avail"/>
											...
											<td width="10%">
												<a ng-click="displayEmail(user.Email)"><i class="fa fa-envelope"></i></a>
												<a ng-click="displayDescription(user.contactTitle)"><i class="fa fa-comment"></i></a>
												<a ng-click="displayPhone(user.PhoneNo)"><i class="fa fa-phone"></i></a>
												<?php
										...
										<div class="row">
											<div class="col-sm-12">										
												<div class="collapse" id="tags-search">
													...
													<div class="checkbox" ng-repeat="tag in FilterData.tags | filter:searchtags">
