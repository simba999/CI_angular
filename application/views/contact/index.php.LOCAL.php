                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <table id="exampleForContactTbl" class="table table-bordered contact-list-table">
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="avatar avatar-circle">
                                                <?php if (empty($ConMemData->ProfileImage)) { ?>
                                            ...
                                            <div class="media-body">
                                                <h5 class="media-heading">
                                                    ...
                                                    <a ng-click="editContactData($event)" href="javascript:void(0);" leadId = {{<?php echo $ConMemData->contactId; ?>}}  ><i class="fa fa-pencil" ></i></a>
                                                </h5>														
                                            </div>
                                        </td>
                                        <td>
                                ...
                                <select class="form-control BoxSizeForAssign AssignForWidth assigned_status_id" id="assigned_status_id">
    <?php
    foreach ($teamMembersAssigned as $assignValue) {
        ?>
                                        <option id="hhh" class="addSelected" value="<?php echo $assignValue->AssignedId; ?>" name="<?php echo $assignValue->AssignedUserName; ?>" >
                                        <?php echo $assignValue->AssignedUserName; ?>
                                        </option>
                                        <?php } ?>
                                            </select>
                                            <!-- </select>
                                ...
                                <a onclick="displayPhone('<?php echo $ConMemData->PhoneNo; ?>')"><i class="fa fa-phone"></i></a>
                                            <?php //echo '<script>alert("You Have Successfully updated this Record!");</script>'; ?>
                                        </td>												
                                    </tr>
                                <?php } ?>
                            </tbody>
                                        ...
                                        <div class="form-group interactionDropdownControlSection">	
                                            <div class="col-md-12 interactionDate">
                                                ...
                                                <div class="input-group date" id="interactionDatePicker">
                                                    <input ng-model="form.interactionDate" type="text" class="form-control" name="interactionDate" placeholder="yyyy-mm-dd" id="interactionDate" required >
                                    ...
                                    <div class="col-md-12">			
                                        <div class="form-group">
                                            <div class="col-md-12 interactionTitle">
                                                ...
                                                <textarea ng-model="form.interactionTitle" name="interactionTitle" rows="5" cols="7" class="form-control" id="interactionTitle" required></textarea>
									...
									<div class="col-md-12">
										<div class="form-group">
											<div class="col-md-12 interactionFormControls">
												<button ng-disabled="addInteractionType.$invalid" type="submit" class="btn-yellow btn btn-success createLeadInteractionSubmitButton">Submit</button>
