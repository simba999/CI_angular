<div class="modal snooze" id="contact-add" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog stepOneEmailConnect" id="add-25-contacts">
        <div class="modal-content stepOneEmailConnectLeftRightSpace">
           ...
           <!-- <div class="modal-header">
			...
			<div class="modal-header">
			    <div class="row">
					<div class="col-sm-12">
						<p class="step-text topMarginStep3"><span class="text-uppercase">STEP</span> 3 of 4 </p>
						<h4 class="modal-title text-uppercase" id="myModalLabel">Add 25 Contacts to circles</h4>
				    </div>
				</div>
    		</div>
			<div class="modal-body">
					<div class="row">
						<div class="col-sm-12">
								<?php for($i=1;$i<=25;$i++){
										...
										if($i == 25)
										{
											$lastRowClass = "last-row-contact-add";
										}
								?>
								<div class="row <?php echo $lastRowClass; ?>">
									<div class="col-md-6">
            ...
            <div class="modal-footer">
            		<div class="add-25-contacts">
								<button type="submit" class="btn btn-yellow marLeftForStepThree">Add</button>
			...
			<div class="modal_n_footer">
				<div class="row">
				<?php if(!$this->session->userdata('calenderConnect') && !$this->session->userdata('firstMessageSent')){ ?>
					<div class="col-sm-6 text-left">
						<a href="javascript:;" ng-click="calendarPreviousPopup($event)" class=""><i class="fa fa-chevron-left"></i> Prev</a>						
					</div>
					<div class="col-sm-6 text-right">
						<a href="javascript:;" ng-click="sendFirstMessage($event)" class="">Next <i class="fa fa-chevron-right"></i></a>        					
					</div>
				<?php } 
				else if(!$this->session->userdata('calenderConnect')){ ?>
